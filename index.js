...
break;
  ...
  const termoPesquisa = 'neymar fodendo'; // Altere para capturar do usuário se necessário
  const urlXvideos = `https://world-ecletix.onrender.com/api/xvideos?termo=${encodeURIComponent(termoPesquisa)}`;
...
case 'xnxx':
  ...
  const termoPesquisa = 'neymar fodendo'; // Modifique para capturar do usuário se necessário
  const urlXnxx = `https://world-ecletix.onrender.com/api/xnxx?query=${encodeURIComponent(termoPesquisa)}`;
...
case 'pornogratis':
  ...
  const termoPornogratis = 'neymar fodendo'; // Pode ser capturado do usuário
...
case 'pornhub':
  ...
  const termoPesquisa = 'neymar fodendo'; // Modifique para capturar do usuário se necessário
  const urlPornhub = `https://world-ecletix.onrender.com/api/pornohub?termo=${encodeURIComponent(termoPesquisa)}`;
