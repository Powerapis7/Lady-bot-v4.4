...
case 'downloads':
    async function downloadMsg() {
        ...
        const { key } = await loli.sendMessage(from, { text: '*❰ Iniciando download... ❱*', quoted: info });

        // Atualiza a mensagem com o progresso
        for (let i = 0; i < carregando.length; i++) {
            await new Promise((resolve) => setTimeout(resolve, 1000)); // Pausa de 1 segundo
            await loli.sendMessage(from, { text: carregando[i], edit: key });
        }

        // Reação ao envio do menu
        await loli.sendMessage(from, { react: { text: '⚡', key: info.key }});

        // Configuração do template da mensagem
        ...
        // Envio da mensagem
        await loli.sendMessage(from, templateMassage);
    }

    // Chama a função e termina o case
    await downloadMsg();
    break;

case 'menuconsulta':
case 'consultas':
    async function consultaMsg() {
        const carregando = [
            '*𝚌𝚊𝚛𝚛𝚎𝚐𝚊𝚗𝚍𝚘...*\n*《 ▒▒▒▒▒▒▒▒▒▒》0%*',
            '*𝚌𝚊𝚛𝚛𝚎𝚐𝚊𝚗𝚍𝚘...*\n*《 █▒▒▒▒▒▒▒▒▒》10%*',
            '*𝚌𝚊𝚛𝚛𝚎𝚐𝚊𝚗𝚍𝚘...*\n*《 ██▒▒▒▒▒▒▒▒》20%*',
        ...
        // Envia a mensagem inicial
        const { key } = await loli.sendMessage(from, { text: '*❰ Iniciando consulta... ❱*', quoted: info });
...
case 'noticias':
    async function noticiaMsg() {
        ...
        // Envia a mensagem inicial
        const { key } = await loli.sendMessage(from, { text: '*❰ Iniciando as notícias... ❱*', quoted: info });
...
let api = await fetchJson(`https://carisys.online/youtube/pesquisar?q=${q}`)

reply(" Baixando o video solicitado.. ")

await loli.sendMessage(from, 
{video: 
{url: `https://carisys.online/api/downloads/youtube/mp4?url=${api.resultado[0].url}`},
mimetype: "video/mp4"}, 
{quoted: info})
...
music = await fetchJson(`https://carisys.online/youtube/pesquisar?q=${q}`)
...
from,
{audio: 
{url:`https://carisys.online/api/downloads/youtube/mp3-2?url=${music.resultado[0].url}`},
mimetype: "audio/mpeg"},
{quoted: info});
...
┗━━━━━━━━━━━━━━━✨
	...
	case 'Playvideo': case 'playvideo': case 'clipe': case 'videoclipe': {
    try {
...
case 'Lady':
  ...
  try {
    ...
    const response = await fetch(`https://world-ecletix.onrender.com/api/lady?texto=${texto}`);
    const data = await response.json();

    if (data.resposta) {
      loli.sendMessage(from, { text: `🗣️ Resposta da Lady: ${data.resposta}` }, { quoted: info });
...
case 'ia':
  ...
  try {
    ...
    const response = await fetch(`https://world-ecletix.onrender.com/api/ia?texto=${textoIa}`);
    const data = await response.json();
    ...
    if (data.resposta) {
      ...
      reply("🚨 Não consegui obter a resposta da IA. Tente novamente mais tarde.");
    }
  } catch (error) {
  ...
  try {
    ...
    const response = await fetch(`https://world-ecletix.onrender.com/api/gemini?texto=${textoGemini}`);
    const data = await response.json();
    ...
    if (data.resposta) {
      ...
      reply("🚨 Não consegui obter a resposta do Gemini. Tente novamente mais tarde.");
    }
  } catch (error) {
  ...
  try {
    ...
    const response = await fetch(`https://world-ecletix.onrender.com/api/geminipro?texto=${textoGeminipro}`);
    const data = await response.json();
    ...
    if (data.resposta) {
      ...
      reply("🚨 Não consegui obter a resposta do GeminiPro. Tente novamente mais tarde.");
    }
  } catch (error) {
  ...
  try {
    ...
    const response = await fetch(`https://world-ecletix.onrender.com/api/chatgpt?texto=${textoChatGPT}`);
    const data = await response.json();
...
case 'gpt3.5-turbo':
  ...
  try {
    ...
    const response = await fetch(`https://world-ecletix.onrender.com/api/gpt3.5-turbo?texto=${textoGpt35Turbo}`);
    const data = await response.json();
  ...
  try {
    ...
    const response = await fetch(`https://world-ecletix.onrender.com/api/gpt4?texto=${textoGpt4}`);
    const data = await response.json();
...
case 'gpt4v2':
  ...
  try {
    ...
    const response = await fetch(`https://world-ecletix.onrender.com/api/gpt4v2?texto=${textoGpt4v2}`);
    const data = await response.json();
...
case 'llama':
  ...
  try {
    ...
    const response = await fetch(`https://world-ecletix.onrender.com/api/llama?texto=${textoLlama}`);
    const data = await response.json();
...
case 'blackbox':
  ...
  try {
    ...
    const response = await fetch(`https://world-ecletix.onrender.com/api/blackbox?texto=${textoBlackbox}`);
    const data = await response.json();
  ...
  try {
    ...
    const response = await fetch(`https://world-ecletix.onrender.com/api/lumin?query=${queryLumin}`);
    const data = await response.json();
...
case 'wwdgpt':
  ...
  try {
    ...
    const response = await fetch(`https://world-ecletix.onrender.com/api/wwdgpt?prompt=${promptWWDGPT}`);
    const data = await response.json();
...
case 'letmegpt':
  ...
  try {
    ...
    const response = await fetch(`https://world-ecletix.onrender.com/api/letmegpt?query=${queryLetMeGPT}`);
    const data = await response.json();
  ...
  try {
    ...
    const response = await fetch(`https://world-ecletix.onrender.com/api/simsimi?query=${querySimsimi}`);
    const data = await response.json();
  ...
  try {
    ...
    const response = await fetch(`https://world-ecletix.onrender.com/api/gpt4-o?texto=${textoGpt4O}`);
    const data = await response.json();
