...
break;
  ...
  const termoPesquisaXvideos = message.text.slice(8).trim(); // Presumindo que o comando seja algo como '!xvideos neymar fodendo'

  if (!termoPesquisaXvideos) {
...
case 'xnxx':
  ...
  // Capturar o termo de pesquisa do usuário
  const termoPesquisaXnxx = message.text.slice(6).trim(); // Presumindo que o comando seja algo como '!xnxx neymar fodendo'
...
case 'pornhub':
  ...
  // Capturar o termo de pesquisa do usuário
  const termoPesquisaPornhub = message.text.slice(9).trim(); // Presumindo que o comando seja algo como '!pornhub neymar fodendo'
