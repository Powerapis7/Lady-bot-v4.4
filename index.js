...
case 'verificarban': {
    try {
        ...
        const response = await fetch(`https://world-ecletix.onrender.com/api/banido?id=${encodeURIComponent(q)}`);
...
case 'ffeventos': {
    try {
        const response = await fetch(`https://world-ecletix.onrender.com/api/eventos`);
