...
case 'seuanimal'://feito por jp
    try {
        ...
        const animalEscolhido = animais[Math.floor(Math.random() * animais.length)]; // Escolhendo um animal aleatório

        const mensagem = `
🦄✨ *QUAL ANIMAL DE BOSTA VOCÊ SERIA?* ✨🦄
━━━━━━━━━━━━━━━
...
case 'pika'://feito por jp
    try { 
        ...
        const mensagem = `🌟✨ *QUAL O TAMANHO DA SUA PIKA?* ✨🌟━━━━━━━━━━━━━━━💫 O tamanho da sua pika é: *${tamanhoEscolhido}* ━━━━━━━━━━━━━━━😄 *Combina com você?* 😂`;
        reply(mensagem); 
    } catch (error) { 
        console.error(error); 
        reply("❌ *Deu erro, Tenta de novo!* ❌"); 
...
break;
[1/2 13:59] null: case 'sorte'://feito por jp
    try {
        const sortes = [
...
try {
    ...
    if (!args[0]) {
        url = 'https://www.themealdb.com/api/json/v1/1/random.php'; // Pega uma receita aleatória
    } else {
    ...
    const categoria = receita.strCategory;
...
case 'suafrase'://jp
    try {
        ...
        const mensagem = `
✨ *VIBRANDO ENERGIA POSITIVA! ✨* 
━━━━━━━━━━━━━━━━━━━━
🗣️ *Frase inspiradora:* ${fraseEscolhida.texto}
🌟 *Emoji da sorte:* ${fraseEscolhida.emoji} 
━━━━━━━━━━━━━━━━━━━━
💬 *Agora é só acreditar e seguir em frente!* 💪
        ...
        console.error(error);
        reply("❌ *Opa, deu um erro ao pegar a frase!* ❌");
    }
    break;
case 'seujogo'://jp
    try {
...
😂 *Tá jogando ou só reclamando do lag?* 😜
 ...
 case 'riqueza'://jp
    try {
        ...
        const riquezaEscolhida = riquezas[Math.floor(Math.random() * riquezas.length)]; // Escolhendo a porcentagem de riqueza aleatória

        const mensagem = `
💰 *SUA RIQUEZA É:* 💰
━━━━━━━━━━━━━━━━━━━━
💸 *Você tem ${riquezaEscolhida.riqueza} de riqueza* ${riquezaEscolhida.emoji}
...
⚡ *Invista com sabedoria, a fortuna pode vir a qualquer momento!* ⚡
 ...
 case 'pobreza'://jp
    try {
        ...
        const pobrezaEscolhida = pobrezas[Math.floor(Math.random() * pobrezas.length)]; // Escolhendo a porcentagem de pobreza aleatória

        const mensagem = `
💸 *SUA POBREZA É:* 💸
━━━━━━━━━━━━━━━━━━━━
🍞 *Você está com ${pobrezaEscolhida.pobreza} de pobreza* ${pobrezaEscolhida.emoji}
...
━━━━━━━━━━━━━━━━━━
📊 *Você é* *${porcentagem}%* *antissocial!*  
━━━━━━━━━━━━━━━━━━
