  ...
  async function upload(midia) {
    return new Promise(async (resolve, reject) => {
      try {
        ...
        await fetchJson('https://catbox.moe/user/api.php', {
          method: 'POST',
          body: form
        })
...
try { 
    ...
    if (isQuotedImage) {
        ...
        async function uploadImageToUguu(imageBuffer) {
            ...
            const response = await fetchJson('https://uguu.se/upload', {
                method: 'POST',
                body: form
            });
            ...
            try {
              if (isQuotedImage) {
                ...
                async function uploadImageToTelegraph(imageBuffer) {
                  ...
                  const response = await fetchJson('https://telegra.ph/upload', {
                    method: 'POST',
                    body: form,
                  });
                  const data = await response.json();
...
photoAptoideBuffer = await(await fetchJson(aptoide.data.datalist.list[0].graphic)).buffer(),
...
case 'vasconews': 
    ...
    try {
        const response = await fetchJson(`https://tohka.online/api/dl/PortalZacariasDlAll?apikey=Xd2Zdpju3M`);
...
case 'zacarias_noticias': {
    try {
        const response = await fetchJson(`https://tohka.online/api/pesquisa/portalzacarias?apikey=Xd2Zdpju3M`);
...
case 'esporte': 
  try {
    const response = await fetchJson('https://tohka.online/api/outros/globoesportes?apikey=Xd2Zdpju3M');
    const data = await response.json();
...
case 'temporal': {
    try {
        ...
        let city = q;
        let response = await fetchJson(`https://wttr.in/${city}?format=j1`);
...
case 'feriados':
    ...
    try {
    const resposta = await fetchJson(`https://api.invertexto.com/v1/holidays/${q}?token=5980|9n1NZ449fdM1Hxs8K8urHxDZRVfEznwI&state=br`);
  ...
  try {
    ...
    if (isQuotedImage) {
      ...
      if (perfilUrl && perfilUrl.startsWith('http')) {
        ...
        const responsePerfilzap = await fetchJson(apiUrl);
...
case 'pinterest':
    ...
    try {
        const response = await fetchJson(pinterestApiUrl);
        ...
        const imageResponse = await fetchJson(randomUrl);
        if (!imageResponse.ok) {
...
case 'pinterest2':
    ...
    try {
        const response = await fetchJson(apiUrlPinterest2);
...
🔗 *Link:* https://www.instagram.com/${profile.username || username}
    ...
    const avatarResponse = await fetchJson(profile.avatar);
...
case 'namoro':
  ...
  try {
    ...
    const response = await fetchJson(namoroApiUrl);
...
case 'editbranca':
  ...
  try {
    const response = await fetchJson(`https://tohka.online/api/canvas/editbranca?nick=${nickBranca}&img=https://i.pinimg.com/564x/96/70/98/967098685058d9b14f5b715fd43e88d1.jpg&apikey=Xd2Zdpju3M`);
...
case 'editvermelha':
  ...
  try {
    const response = await fetchJson(`https://tohka.online/api/canvas/editvermelha?nick=${nickVermelha}&img=https://telegra.ph/file/d3f32c55c57b738806acf.png&apikey=Xd2Zdpju3M`);
...
case 'editroxo':
  ...
  try {
    const response = await fetchJson(`https://tohka.online/api/canvas/editroxo?nick=${nickRoxo}&img=https://telegra.ph/file/edd98b4aefa226c05e60d.jpg&apikey=Xd2Zdpju3M`);
...
case 'xvdownload': {
    try {
        ...
        const response = await fetchJson(`https://tohka.online/api/dl/xvideos?link=${encodeURIComponent(q)}&apikey=Xd2Zdpju3M`);
...
case 'xnxxdownload': {
    try {
        ...
        const response = await fetchJson(`https://tohka.online/api/dl/xnxx?link=${encodeURIComponent(q)}&apikey=Xd2Zdpju3M`);
...
break;
  ...
  try {
    const responseXvideos = await fetchJson(urlXvideos);
...
case 'pornogratis':
  ...
  try {
    const responsePornogratis = await fetchJson(urlPornogratis);
...
case 'pornohub':
  ...
  try {
    const responsePornhubsrc = await fetchJson(urlPornhubsrc);
...
case 'assistirhentai':
  ...
  try {
    const responseAssistirhentai = await fetchJson(urlAssistirhentai);
...
case 'hentaistuber':
  ...
  try {
    const responseHentaistuber = await fetchJson(urlHentaistuber);
...
case 'hentaiword':
  ...
  try {
    const responseHentaiword = await fetchJson(urlHentaiword);
...
case 'frases': {
    try {
        ...
        const response = await fetchJson(`https://world-ecletix.onrender.com/api/pensador?nome=${encodeURIComponent(q)}`);
...
case 'pensador': {
    try {
        const response = await fetchJson(`https://world-ecletix.onrender.com/api/frasespensador`);
        if (!response.ok) return reply("Erro ao buscar as frases.");
...
case 'biblia': case 'bíblia': case 'Bíblia': case 'Biblia': {
    try {
        ...
        const response = await fetchJson(`https://tohka.online/api/pesquisa/biblia?versiculo=${encodeURIComponent(q)}&apikey=Xd2Zdpju3M`);
...
case 'verificarban': {
    try {
        ...
        if (!response.ok) return reply("Erro ao verificar banimento.");
        ...
        const statusBan = data.isBanned === "yes" ? "🚨 *Usuário BANIDO!* 🚨" : "✅ *Usuário não está banido.*";
...
case 'ffeventos': {
    try {
        ...
        if (!response.ok) return reply("Erro ao buscar os eventos.");
...
case 'sabetudo':
  ...
  try {
    ...
    const response = await fetchJson(`https://world-ecletix.onrender.com/api/sabetudo?texto=${pergunta}`);
    const data = await response.json();
