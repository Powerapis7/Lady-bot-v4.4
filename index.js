...
case 'pergunta':
try {
ABC = await fetchJson(`https://api.bronxyshost.com.br/api-bronxys/PERGUNTE_E_EU_RESPONDO?q=${q.trim()}&apikey=Nova_Key-Da-Bronxys-Por-IP-Limitado-2023@@`)
reply(`( ${ABC.msg} )`)
} catch { 
reply("Erro..")
}
...
ABC = await fetchJson(`https://api.bronxyshost.com.br/api-bronxys/google-img?nome=${q}&apikey=Nova_Key-Da-Bronxys-Por-IP-Limitado-2023@@`);
...
try {
ABC = await fetchJson(`https://api.bronxyshost.com.br/api-bronxys/esporte_noticias?apikey=Nova_Key-Da-Bronxys-Por-IP-Limitado-2023@@`)
AB =""
...
data = await fetchJson(`https://api.bronxyshost.com.br/api-bronxys/playstore?nome=${q}&apikey=Nova_Key-Da-Bronxys-Por-IP-Limitado-2023@@`)
...
ABC = await fetchJson(`https://api.bronxyshost.com.br/api-bronxys/info_celular?celular=${q}&apikey=Nova_Key-Da-Bronxys-Por-IP-Limitado-2023@@`);
...
try {
reply("Aguarde..")
ABC = await fetchJson(`https://api.bronxyshost.com.br/api-bronxys/Amazon_Pesquisa?pesquisa=${q.trim()}&apikey=Nova_Key-Da-Bronxys-Por-IP-Limitado-2023@@`)
RST = "Pesquisa Amazon:\n\n"
...
AB = await fetchJson(`https://api.bronxyshost.com.br/api-bronxys/pesquisa_ytb?nome=${q}&apikey=Nova_Key-Da-Bronxys-Por-IP-Limitado-2023@@`)
ABC = `${"-\t".repeat(13)}\n\n`
for (var i of AB) {
ABC += `Titulo: ${i.titulo}\nUrl: ${i.url}\nTempo: ${i.tempo}\nPostado: ${i.postado}\n\nDescrição: ${i.desc}\n\n`;
ABC += `${"-\t".repeat(13)}\n\n`
...
try {
loli.sendMessage(from, {image: {url: `https://api.bronxyshost.com.br/api-bronxys/print_de_site?url=${q.trim()}&apikey=Nova_Key-Da-Bronxys-Por-IP-Limitado-2023@@`}}, {quoted: info}) 
} catch {
return reply("Erro..");
}
break;
...
fetch(`https://api.bronxyshost.com.br/transcrever?apikey=Nova_Key-Da-Bronxys-Por-IP-Limitado-2023@@`, {
method: 'POST',
body: formData
...
data = await fetchJson(`https://api.bronxyshost.com.br/api-bronxys/pesquisa_ytb?nome=${q}&apikey=Nova_Key-Da-Bronxys-Por-IP-Limitado-2023@@`)
...
loli.sendMessage(from, {audio: {url: `https://api.bronxyshost.com.br/api-bronxys/play?nome_url=${q}&apikey=Nova_Key-Da-Bronxys-Por-IP-Limitado-2023@@`}, mimetype: "audio/mpeg", fileName: data[0]?.titulo || "play.mp3"}, {quoted: info}).catch(e => {
return reply("Erro..")
})
} catch (e) {
console.log(e)
...
`
loli.sendMessage(from, {image: {url: data[0]?.thumb || logoslink?.logo}, caption: bla}, {quoted: info})
loli.sendMessage(from, {video: {url: `https://api.bronxyshost.com.br/api-bronxys/play_video?nome_url=${q}&apikey=Nova_Key-Da-Bronxys-Por-IP-Limitado-2023@@`}, mimetype: "video/mp4", fileName: data[0]?.titulo || "play.mp4"}, {quoted: info}).catch(e => {
return reply("Erro..")
})
} catch (e) {
console.log(e)
...
`
    loli.sendMessage(from, { image: { url: data[0]?.thumb || logoslink?.logo }, caption: bla }, { quoted: info })
    loli.sendMessage(from, { audio: { url: `https://api.bronxyshost.com.br/api-bronxys/play?nome_url=${q}&apikey=Nova_Key-Da-Bronxys-Por-IP-Limitado-2023@@` }, mimetype: "audio/mpeg", fileName: data[0]?.titulo || "play.mp3", ptt: true }, { quoted: info })
      .catch(e => {
        return reply("Erro..")
      })
  } catch (e) {
...
try {
reply("Aguarde...")
const abc = await fetchJson(`https://api.bronxyshost.com.br/api-bronxys/letra_musica?letra=${q.trim()}&apikey=Nova_Key-Da-Bronxys-Por-IP-Limitado-2023@@`)
...
reply("Realizando ação..")
loli.sendMessage(from, {video: {url: `https://api.bronxyshost.com.br/api-bronxys/${command}?url=${q}&apikey=Nova_Key-Da-Bronxys-Por-IP-Limitado-2023@@`}, mimetype: "video/mp4"}).catch(e => {
return reply("Erro..")
})
} catch (e) {
return reply("Erro..")
...
if(!q.includes("facebook") && !q.includes("fb.watch")) return reply(`Exemplo: ${prefix+command} o link do Facebook`);
reply("Realizando ação..")
loli.sendMessage(from, {audio: {url: `https://api.bronxyshost.com.br/api-bronxys/${command}?url=${q}&apikey=Nova_Key-Da-Bronxys-Por-IP-Limitado-2023@@`}, mimetype: "audio/mpeg"}).catch(e => {
return reply("Erro..")
})
} catch (e) {
return reply("Erro..")
...
try {
loli.sendMessage(from, {video: {url: `https://api.bronxyshost.com.br/api-bronxys/threads?url=${q}&apikey=Nova_Key-Da-Bronxys-Por-IP-Limitado-2023@@`}})
} catch (e) {
...
reply(Res_Aguarde);
try {
loli.sendMessage(from, {video: {url: `https://api.bronxyshost.com.br/api-bronxys/kwai?url=${q.trim()}&apikey=Nova_Key-Da-Bronxys-Por-IP-Limitado-2023@@`}, mimetype: "video/mp4"}, {quoted: info})
} catch (e) {
console.log(e);
return reply("Erro...");
}
...
ABC = await fetchJson(`https://api.bronxyshost.com.br/api-bronxys/instagram?url=${q.trim()}&apikey=Nova_Key-Da-Bronxys-Por-IP-Limitado-2023@@`)
reply("Realizando ação..")
...
try {
if(!q.trim()) return reply(`Exemplo: ${prefix+command} naruto`)
ABC = await fetchJson(`https://api.bronxyshost.com.br/api-bronxys/pinterest?nome=${q}&apikey=Nova_Key-Da-Bronxys-Por-IP-Limitado-2023@@`);
...
`
loli.sendMessage(from, {image: {url: data[0]?.thumb || logoslink.logo}, caption: bla}, {quoted: info})
loli.sendMessage(from, {document: {url: `https://api.bronxyshost.com.br/api-bronxys/play?nome_url=${q}&apikey=Nova_Key-Da-Bronxys-Por-IP-Limitado-2023@@`}, mimetype: "audio/mpeg", fileName: data[0]?.titulo || "play.mp3"}, {quoted: info}).catch(e => {
return reply("Erro..")
})
} catch (e) {
console.log(e)
